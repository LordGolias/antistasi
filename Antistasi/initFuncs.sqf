...
AS_fnc_createFIAroadblock = compile preProcessFileLineNumbers "CREATE\createFIAroadblock.sqf";
AS_fnc_createFIACamp = compile preProcessFileLineNumbers "CREATE\createFIACamp.sqf";
