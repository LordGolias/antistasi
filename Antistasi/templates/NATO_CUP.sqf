...
[_dict, "name", "USMC (CUP)"] call DICT_fnc_setLocal;
...
[_dict, "boats", ["CUP_B_RHIB2Turret_USMC"]] call DICT_fnc_setLocal;
...
[_dict, "cars_transport", ["CUP_B_HMMWV_Unarmed_USMC"]] call DICT_fnc_setLocal;
[_dict, "cars_armed", ["CUP_B_HMMWV_MK19_USMC", "CUP_B_HMMWV_M2_USMC", "CUP_B_HMMWV_M1114_USMC", "CUP_B_RG31_M2_OD_USMC", "CUP_B_RG31_Mk19_OD_USMC"]] call DICT_fnc_setLocal;
...
[_dict, "truck_ammo", "CUP_B_MTVR_Ammo_USMC"] call DICT_fnc_setLocal;
[_dict, "truck_repair", "CUP_B_MTVR_Repair_USMC"] call DICT_fnc_setLocal;
