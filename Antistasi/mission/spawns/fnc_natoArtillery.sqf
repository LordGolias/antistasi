private _fnc_initialize = {
	...
	private _tskTitle = (["NATO", "name"] call AS_fnc_getEntity) + " Artillery support";
	private _tskDesc = format [(["NATO", "name"] call AS_fnc_getEntity) + " has given us control over their artillery at %1. They will be under our command until %2:%3.",
