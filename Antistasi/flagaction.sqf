...
switch _tipo do {
	...
	case "unit": {_flag addAction [localize "STR_act_recruitUnit", {nul=[] execVM "Dialogs\unit_recruit.sqf";},nil,0,false,true,"","(isPlayer _this) and (_this == _this getVariable ['owner',objNull])"];};
