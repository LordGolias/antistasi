...
if ((_tipo == "B_G_Soldier_F") or (_tipo == "B_G_Soldier_GL_F") or (_tipo == "B_G_Soldier_LAT_F") or (_tipo == "B_G_Soldier_lite_F") or (_tipo == "B_G_medic_F") or (_tipo == "B_G_engineer_F") or (_tipo == "B_G_Soldier_exp_F") or (_tipo == "B_G_Soldier_A_F")) then
	{
...
if ((_tipo == "B_G_Soldier_SL_F") or (_tipo == "B_G_Soldier_TL_F") or (_tipo == "B_G_officer_F")) then
	{
	removeAllItemsWithMagazines _unit;
