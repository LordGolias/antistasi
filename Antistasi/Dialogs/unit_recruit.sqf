...
if (str (_display) != "no display") then
{
	...
	_ChildControl  ctrlSetTooltip format ["Cost: %1 €",AS_data_allCosts getVariable "B_G_engineer_F"];
	_ChildControl = _display displayCtrl 108;
	_ChildControl  ctrlSetTooltip format ["Cost: %1 €",AS_data_allCosts getVariable "B_G_Soldier_exp_F"];
	...
	_ChildControl  ctrlSetTooltip format ["Cost: %1 €",AS_data_allCosts getVariable "Soldier_AA"];
};