...
BTN_R(1,109, "Train FIA", "Increase HR capacity and FIA skill", "call AS_fncUI_trainFIA");
BTN_R(2,-1, "Rebuild Assets", "Rebuild a destroyed location (5.000 €)", "closeDialog 0; [] spawn AS_fncUI_rebuildAssets;");
BTN_R(3, -1, "Garage Access", "", "closeDialog 0; [false] spawn garage;");
	};
};
