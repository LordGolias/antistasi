...
[_dict, "AS_location", call AS_location_fnc_toDict] call DICT_fnc_set;

diag_log "[AS] Server: serializing fia_hq...";
[_dict, "AS_fia_hq", call AS_database_fnc_hq_toDict] call DICT_fnc_set;
...
[_dict, "AS_persistent", call AS_database_fnc_persistents_toDict] call DICT_fnc_set;

diag_log "[AS] Server: serializing missions...";
[_dict, "AS_mission", call AS_mission_fnc_toDict] call DICT_fnc_set;
