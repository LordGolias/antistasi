private _opSPAA = selectRandom (["CSAT", "self_aa"] call AS_fnc_getEntity);
private _truck = selectRandom (["CSAT", "trucks"] call AS_fnc_getEntity);
private _flag = (["CSAT", "flag"] call AS_fnc_getEntity);
private _box = (["CSAT", "box"] call AS_fnc_getEntity);
private _static_aa = (["CSAT", "static_aa"] call AS_fnc_getEntity);
private _static_at = (["CSAT", "static_at"] call AS_fnc_getEntity);
private _static_mg = (["CSAT", "static_mg"] call AS_fnc_getEntity);
private _static_mg_low = (["CSAT", "static_mg_low"] call AS_fnc_getEntity);
private _static_mortar = (["CSAT", "static_mortar"] call AS_fnc_getEntity);

AS_MTN_Agela = [[9210.11, 8376.76]];
AS_MTN_Agela pushBack [
	[_truck,[4.3418,-1.6709,0.155876],176.582,1,0,[],"","",true,false],
	[_box,[7.19922,1.52051,0.0274963],217.695,1,0.0152418,[],"","",true,false],
	["Land_HBarrier_5_F",[10.2588,4.97363,-0.00943756],220.885,1,0,[],"","",true,false],
	[_flag,[-11.6289,-5.40039,0],0,1,0,[],"","",true,false],
	["Land_HBarrier_5_F",[14.541,1.26953,-0.00440216],220.773,1,0,[],"","",true,false],
	[_opSPAA,[12.1221,10.7012,0.00708771],310.372,1,0,[],"","",true,false],
	...
	[_static_mg,[-20.5957,-4.9873,-0.0769348],193.679,1,0,[],"","",true,false],
	...
	[_static_mg,[-7.9209,23.1299,-0.100998],8.93462,1,0,[],"","",true,false],
	[_static_mortar,[10.875,-22.1826,0.00038147],105.343,1,0,[],"","",true,false],
	...
	[_static_mg,[20.1416,-31.3252,-0.0743484],91.2113,1,0,[],"","",true,false],
	["Land_BagFence_Round_F",[21.6064,-32.416,-0.0335159],321.836,1,0,[],"","",true,false],
	[_static_mg,[33.0107,23.8018,-0.111046],62.0415,1,0,[],"","",true,false],
...
AS_MTN_AgiaStemma pushBack [
	...
	[_flag,[0.0429688,2.5625,0.0172424],0,1,0,[],"","",true,false],
	...
	[_static_aa,[7.79785,-2.6084,-0.0805359],160.172,1,0,[],"","",true,false],
	...
	[_truck,[-10.1396,-2.51465,0.0481567],168.38,1,0,[],"","",true,false],
	["Land_HBarrier_5_F",[10.8828,2.80664,-0.132202],84.9037,1,0,[],"","",true,false],
	[_box,[10.0767,-5.84961,0.000457764],79.1409,1,0.106246,[],"","",true,false],
	...
	[_static_aa,[-10.2705,-10.4375,-0.0065918],206.975,1,0,[],"","",true,false],
	...
	[_static_aa,[-12.4941,10.7744,-0.111389],307.636,1,0,[],"","",true,false],
	["Land_BagFence_Round_F",[-9.77246,13.4336,0.0517273],212.609,1,0,[],"","",true,false],
	[_static_mortar,[-2.48975,16.4404,-0.0637817],359.987,1,0,[],"","",true,false],
	["Land_BagFence_Round_F",[-12.5127,-11.6875,0.255127],61.8115,1,0,[],"","",true,false],
	[_static_mg,[15.7051,-6.46484,-0.0715332],154.878,1,0,[],"","",true,false],
	...
	[_static_aa,[13.4976,12.8945,-0.120026],32.7453,1,0,[],"","",true,false],
	...
	[_static_mg,[-20.8423,3.3125,-0.0811157],277.828,1,0,[],"","",true,false],
...
AS_MTN_AgiosAndreas pushBack [
	[_truck,[2.88477,5.125,0.0275421],176.475,1,0,[],"","",true,false],
	[_box,[-0.0605469,7.80469,0.00138092],308.867,1,0.0097848,[],"","",true,false],
	[_flag,[5.87695,6.05078,0],0,1,0,[],"","",true,false],
	[_opSPAA,[-9.03711,-3.94336,-0.0341187],58.2242,1,0,[],"","",true,false],
	...
	[_static_mortar,[9.29883,-13.6211,-0.0190659],105.47,1,0,[],"","",true,false],
	...
	[_static_at,[-5.48633,-17.9785,-0.0319519],169.841,1,0,[],"","",true,false],
	...
	[_static_mg,[9.41211,18.7109,-0.100784],89.044,1,0,[],"","",true,false],
	...
	[_static_mg,[6.94531,-25.3008,-0.0933228],149.11,1,0,[],"","",true,false],
	...
	[_static_mg,[-10.0918,31.7285,-0.0999832],320.862,1,0,[],"","",true,false],
	[_static_mg,[-29.1035,-16.6934,-0.0705185],227.534,1,0,[],"","",true,false],
...
AS_MTN_AgiosMinas pushBack [
	...
	[_static_mg_low,[-7.91162,8.14063,-0.0396423],302.172,1,0,[],"","",true,false],
	...
	[_opSPAA,[-4.07959,-11.2656,-0.00253296],310.125,1,0,[],"","",true,false],
	["Land_BagFence_Round_F",[8.78027,8.66016,0.240005],156.911,1,0,[],"","",true,false],
	[_static_mortar,[10.9019,6.96289,-0.0450897],199.846,1,0,[],"","",true,false],
	...
	[_static_at,[18.8398,-5.14453,-0.161438],178.664,1,0,[],"","",true,false],
	...
	[_truck,[17.3281,15.8633,-0.00765991],152.264,1,0,[],"","",true,false],
	[_static_mg,[25.8477,0.640625,-0.0767975],137.089,1,0,[],"","",true,false],
	["Land_BagFence_Round_F",[26.2012,-1.04102,-0.00421143],359.741,1,0,[],"","",true,false],
	[_box,[17.3076,20.5371,0.000579834],0.00223059,1,0.00984257,[],"","",true,false],
	["Land_BagFence_Round_F",[27.9331,0.652344,-0.0539551],266.55,1,0,[],"","",true,false],
	[_flag,[25.064,21.9336,0],0,1,0,[],"","",true,false],
	[_static_mg,[-10.9141,-34.2227,-0.0776672],189.415,1,0,[],"","",true,false],
	...
	[_static_mg,[30.48,21.6914,-0.0359802],56.106,1,0,[],"","",true,false],
...
AS_MTN_Amoni pushBack [
	[_opSPAA,[5.31201,0.671875,-0.0928345],264.214,1,0,[],"","",true,false],
	...
	[_truck,[-10.2456,-1.97461,-0.0253296],146.33,1,0,[],"","",true,false],
	...
	[_box,[-14.1016,0.214844,0.000167847],256.936,1,0.00921631,[],"","",true,false],
	["Land_BagFence_Short_F",[-10.231,-11.8594,-0.0144043],308.103,1,0,[],"","",true,false],
	[_flag,[10.0068,11.7695,0],0,1,0,[],"","",true,false],
	[_static_at,[-11.6938,-11.3906,-0.144073],218.973,1,0,[],"","",true,false],
	["Land_BagFence_Short_F",[-13.0547,-9.91016,-0.0939331],308.24,1,0,[],"","",true,false],
	[_static_mg,[-1.70654,16.7637,-0.113617],359.139,1,0,[],"","",true,false],
	...
	[_static_mortar,[22.8213,1.07227,-0.0389557],79.5806,1,0,[],"","",true,false],
	...
	[_static_mg,[-22.9595,-5.12891,-0.0215607],211.354,1,0,[],"","",true,false],
	...
	[_static_mg,[26.9902,-10.6387,-0.0621796],125.087,1,0,[],"","",true,false],
	...
	[_static_mg_low,[32.4355,9.9082,-0.0219574],87.0615,1,0,[],"","",true,false],
...
AS_MTN_Didymos pushBack [
	...
	[_flag,[-8.89063,-5.47754,0],0,1,0,[],"","",true,false],
	["Land_HBarrier_Big_F",[9.85156,-2.77539,0.0224304],329.317,1,0,[],"","",true,false],
	[_opSPAA,[9.87891,3.35742,-0.0560608],236.817,1,0,[],"","",true,false],
	[_truck,[-10.6504,-1.37598,0.0430145],4.03134,1,0,[],"","",true,false],
	[_box,[-9.78125,-6.90332,0.0202942],57.2098,1,0.0115505,[],"","",true,false],
	...
	[_static_mg_low,[9.49023,-11.9385,0.141861],156.8,1,0,[],"","",true,false],
	...
	[_static_mg_low,[-5.58789,16.0273,-0.014389],324.945,1,0,[],"","",true,false],
	...
	[_static_mg,[-24.2949,-1.89063,-0.054245],248.599,1,0,[],"","",true,false],
	...
	[_static_mortar,[24.2539,15.2344,0.127991],59.6308,1,0,[],"","",true,false],
	...
	[_static_mg,[43.4082,26.4238,-0.0737457],62.6585,1,0,[],"","",true,false],
...
AS_MTN_Kira pushBack [
	...
	[_static_mortar,[-0.746094,8.42578,-0.0504761],124.848,1,0,[],"","",true,false],
	[_box,[8.11621,5.2207,0.000488281],54.3764,1,0.00991255,[],"","",true,false],
	...
	[_flag,[-3.28369,13.0566,0],0,1,0,[],"","",true,false],
	[_truck,[11.002,8.77148,0.014679],8.91439,1,0,[],"","",true,false],
	["Land_HBarrier_5_F",[14.5068,-15.2148,-0.223618],220.597,1,0,[],"","",true,false],
	[_opSPAA,[9.59131,-17.6035,-0.00680542],309.994,1,0,[],"","",true,false],
	[_static_mg,[-1.60498,20.373,-0.085495],338.465,1,0,[],"","",true,false],
	...
	[_static_mg_low,[-29.6631,6.02734,-0.0368195],275.656,1,0,[],"","",true,false],
	...
	[_static_at,[15.6187,-30.9277,-0.136185],170.738,1,0,[],"","",true,false],
	...
	[_static_mg,[25.0874,-30.9648,-0.095871],122.567,1,0,[],"","",true,false],
	...
	[_static_mg_low,[2.44189,-41.2012,-0.0153961],177.196,1,0,[],"","",true,false],
...
AS_MTN_Pyrsos pushBack [
	...
	[_flag,[-12.1191,-4.69922,0],0,1,0,[],"","",true,false],
	[_static_mortar,[12.958,0.226563,0.00619507],26.3412,1,0,[],"","",true,false],
	...
	[_box,[-15.876,-5.02734,3.05176e-005],13.8785,1,0.00985034,[],"","",true,false],
	...
	[_truck,[-20.7744,-2.45117,-0.0109253],242.949,1,0,[],"","",true,false],
	[_static_mg,[-17.457,-12.3613,-0.112274],176.463,1,0,[],"","",true,false],
	[_opSPAA,[-15.0801,15.2344,-0.0490112],60.0282,1,0,[],"","",true,false],
	...
	[_static_mg,[5.17188,23.7754,-0.100067],61.927,1,0,[],"","",true,false],
	...
	[_static_mg,[-13.0459,33.7344,-0.0898438],338.361,1,0,[],"","",true,false],
	...
	[_static_mg_low,[-5.42871,-37.5664,-0.00808716],199.151,1,0,[],"","",true,false],
	[_static_at,[-3.39746,-37.8457,-0.0828552],199.462,1,0,[],"","",true,false],
	...
	[_static_mg,[36.3916,-13.2148,-0.0795288],122.189,1,0,[],"","",true,false],
...
AS_MTN_Riga pushBack [
	...
	[_opSPAA,[-1.35938,8.79199,-0.0558701],177.55,1,0,[],"","",true,false],
	...
	[_static_mg,[10.082,-21.2197,-0.0571747],166.87,1,0,[],"","",true,false],
	[_static_mortar,[-1.18848,23.4795,-0.0384293],354.207,1,0,[],"","",true,false],
	...
	[_truck,[20.4854,15.3213,-0.0112839],13.8512,1,0,[],"","",true,false],
	["Land_BagFence_Long_F",[-1.3457,25.7686,-0.000999451],354.622,1,0,[],"","",true,false],
	[_box,[23.9219,11.2559,0.00012207],144.769,1,0.00983477,[],"","",true,false],
	[_flag,[26.5801,10.8018,0],130.877,1,0,[],"","",true,false],
	...
	[_static_at,[31.4258,5.01758,-0.13208],84.0392,1,0,[],"","",true,false],
	[_static_mg_low,[31.8467,3.11035,-0.0355072],84.1712,1,0,[],"","",true,false],
	...
	[_static_mg,[-30.4297,24.1865,-0.0869064],326.635,1,0,[],"","",true,false],
	[_static_at,[1.41895,38.9414,-0.0702286],3.67325,1,0,[],"","",true,false],
	[_static_mg_low,[3.38867,38.9932,0.00167847],3.24935,1,0,[],"","",true,false],
	...
	[_static_mg,[28.9111,31.6201,-0.0975037],39.4702,1,0,[],"","",true,false],
	...
	[_static_mg_low,[-54.002,-18.5977,0.0522308],250.711,1,0,[],"","",true,false],
	[_static_at,[-53.3838,-20.6738,-0.00646973],252.792,1,0,[],"","",true,false],
	...
	[_static_mg,[-75.3594,-11.8398,0.0259094],251.278,1,0,[],"","",true,false],
...
AS_MTN_Skopos pushBack [
	...
	[_static_mortar,[-4.40039,-0.792969,-0.0159454],266.221,1,0,[],"","",true,false],
	...
	[_box,[1.61426,8.94629,0.000518799],94.7313,1,0.00982795,[],"","",true,false],
	[_truck,[-3.53516,10.1841,0.00471497],317.34,1,0,[],"","",true,false],
	[_opSPAA,[11.9277,-1.25049,-0.0427094],95.6806,1,0,[],"","",true,false],
	[_flag,[1.70996,12.5879,0],130.877,1,0,[],"","",true,false],
	...
	[_static_mg,[-14.3135,-21.7207,-0.053894],220.19,1,0,[],"","",true,false],
	...
	[_static_at,[8.62305,27.7075,-0.156876],3.73005,1,0,[],"","",true,false],
	...
	[_static_mg_low,[10.6006,27.7925,-0.014328],3.29392,1,0,[],"","",true,false],
	[_static_mg,[-28.0879,10.1362,-0.0263062],264.9,1,0,[],"","",true,false],
	...
	[_static_mg,[34.4453,0.3125,-0.102371],39.7189,1,0,[],"","",true,false],
	...
	[_static_mg,[17.2773,-32.4492,0.087677],166.241,1,0,[],"","",true,false],
...
AS_MTN_Synneforos pushBack [
	...
	[_opSPAA,[-7.12646,1.21875,0.0325012],95.5878,1,0,[],"","",true,false],
	...
	[_truck,[-15.3115,-7.46094,-0.0145264],279.136,1,0,[],"","",true,false],
	["Land_BagFence_Corner_F",[-9.48242,15.4063,-0.0803528],5.63424,1,0,[],"","",true,false],
	[_box,[-17.9111,-4.33398,0.00161743],319.506,1,0,[],"","",true,false],
	[_static_mg_low,[-11.1553,14.8105,-0.0447388],0.381093,1,0,[],"","",true,false],
	...
	[_static_at,[-13.1431,14.7207,-0.148895],3.58366,1,0,[],"","",true,false],
	[_static_mg,[19.1421,-6.12109,-0.0855408],117.08,1,0,[],"","",true,false],
	...
	[_flag,[-20.52,-3.80078,0],130.877,1,0,[],"","",true,false],
	...
	[_static_mortar,[-21.0576,4.63281,-0.0133972],266.15,1,0,[],"","",true,false],
	...
	[_static_mg_low,[-16.2104,-14.9004,0.0392151],208.793,1,0,[],"","",true,false],
	...
	[_static_mg,[-35.3613,5.1543,-0.0903015],264.788,1,0,[],"","",true,false],
	...
	[_static_at,[27.022,-25.9336,-0.161133],199.888,1,0,[],"","",true,false],
...
AS_MTN_Thronos pushBack [
	...
	[_opSPAA,[20.2227,8.07813,-0.055603],321.664,1,0,[],"","",true,false],
	...
	[_static_mg,[24.1064,-8.66016,-0.0745544],265.743,1,0,[],"","",true,false],
	...
	[_static_mg_low,[10.6099,-28.1543,-0.019165],177.652,1,0,[],"","",true,false],
	...
	[_truck,[-38.3887,-2.56055,0.107788],1.47981,1,0,[],"","",true,false],
	["Land_BagFence_Corner_F",[-16.3369,36.3398,-0.071228],103.572,1,0,[],"","",true,false],
	[_box,[-39.5176,-7.61914,0.00512695],327.907,1,0.00893501,[],"","",true,false],
	["Land_BagFence_Short_F",[-17.7344,36.6465,-0.11676],191.753,1,0,[],"","",true,false],
	[_static_at,[-17.2964,38.1328,-0.13913],101.556,1,0,[],"","",true,false],
	...
	[_flag,[-47.1118,8.46484,0],0,1,0,[],"","",true,false],
	...
	[_static_at,[-36.1826,36.3477,-0.125916],222.578,1,0,[],"","",true,false],
	...
	[_static_mg_low,[57.1069,-10.457,-0.0308533],89.3368,1,0,[],"","",true,false],
	...
	[_static_mortar,[-58.6455,20.3984,-0.036438],206.534,1,0,[],"","",true,false],
	...
	[_static_mg,[-17.124,61.9551,-0.0612183],61.6532,1,0,[],"","",true,false],
