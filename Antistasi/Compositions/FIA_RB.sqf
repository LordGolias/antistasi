private _armed_car = selectRandom (["FIA", "cars_armed"] call AS_fnc_getEntity);

FIA_RB1_1 =
[
	[_armed_car,[4.1333,-0.0429688,0.00792694],180.707,1,0,[-0.621232,-0.00125634],"","",true,false],
...
[
	...
	[_armed_car,[4.68799,0.154297,0.00717878],180.583,1,0,[-0.599408,-0.0241427],"","",true,false],
...
[
	...
	[_armed_car,[3.98584,0.365234,-0.0162253],180.538,1,0,[-0.511416,-0.0957463],"","",true,false],
...
FIA_RB2_2 =
[
	[_armed_car,[4.06958,-0.09375,-0.00249958],179.945,1,0,[-0.541028,-0.0944687],"","",true,false],
...
[
	...
	[_armed_car,[4.03027,-0.601074,0.00751448],179.606,1,0,[-0.602296,-0.0139068],"","",true,false],
...
[
	...
	[_armed_car,[4.34985,0.280273,-0.0176225],179.467,1,0,[-0.508473,-0.0925699],"","",true,false],
...
fnc_RB_placeSingle = {
...

	{
		...
		if (typeof _x in (["FIA", "cars_armed"] call AS_fnc_getEntity)) then {
        	_vehicle = _x;
   		};
	} forEach _objs;
